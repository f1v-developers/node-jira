...
var JiraApi = exports.JiraApi = function(protocol, host, port, username, password, apiVersion, verbose, strictSSL, oauth, base, httpOptions) {
    ...
    this.doRequest = function(options, callback) {
        ...
        for (var attrname in this.httpOptions) {
            options[attrname] = this.httpOptions[attrname];
        }
